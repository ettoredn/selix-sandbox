...
const zend_function_entry sephp_functions[] = {
	...
	{NULL, NULL, NULL}	/* Must be the last line in sephp_functions[] */
};
/* }}} */
...
PHP_INI_BEGIN()
    STD_PHP_INI_ENTRY("sephp.global_value",      "42", PHP_INI_ALL, OnUpdateLong, global_value, zend_sephp_globals, sephp_globals)
    STD_PHP_INI_ENTRY("sephp.global_string", "foobar", PHP_INI_ALL, OnUpdateString, global_string, zend_sephp_globals, sephp_globals)
PHP_INI_END()
*/
/* }}} */

/* {{{ php_sephp_init_globals
 */
/* Uncomment this function if you have INI entries
static void php_sephp_init_globals(zend_sephp_globals *sephp_globals)
{
	sephp_globals->global_value = 0;
	sephp_globals->global_string = NULL;
}
*/
/* }}} */
...
/* {{{ proto string confirm_sephp_compiled(string arg)
...
PHP_FUNCTION(confirm_sephp_compiled)
{
	...
	len = spprintf(&strg, 0, "Congratulations! You have successfully modified ext/%.78s/config.m4. Module %.78s is now compiled into PHP.", "sephp", arg);
